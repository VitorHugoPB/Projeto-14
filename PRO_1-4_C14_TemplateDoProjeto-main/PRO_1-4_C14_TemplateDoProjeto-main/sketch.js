 ...
 background(0);
  ...
  if (World.frameCount % 100 == 0) {
   switch(select_balloon ){
    case 1: createRed_balloon();//chamar o balão vermelho
    break;
    case 2: createGreen_balloon();// chamar o balão azul
    break;
    case 3: createPink_balloon();// chamar o balão verde
    break;
    case 4: createBlue_balloon();// chamar o balão rosa
    break;
    default:break;
  }}
...
function blueBalloon() {
  //crieSprite para o balãovar red = createSprite(0,Math.round(random(20, 370)), 10, 10);
